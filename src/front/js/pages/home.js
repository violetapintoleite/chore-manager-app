...
import signup from "../../../front/img/signup.png";
import addachore from "../../../front/img/addachore.png";
import singlemetrics from "../../../front/img/singlemetrics.png";
import teammetrics from "../../../front/img/teammetrics.png";
      ...
      <div className="overflow">
        ...
        <div className="">
          <div className="d-flex m-2 homepage-card-container ">
            <div className="shadow-none col-5 first-section">
              <img
                src={signup}
            ...
            <div className="container d-flex text-section first-section align-middle pb-4">
              ...
              <div className="container first-section col-4 pt-4">
                <h2 className="pt-2 home-page-card-titles text-white">
                  Create an account
                </h2>
          ...
          <div className="d-flex m-2 pt-3 homepage-card-container ">
            <div className="text-section second-section d-flex">
              ...
              <div className="container second-section home-page-text text-white col-4 pt-4">
                <h2 className="pt-2 home-page-card-titles">
                  Log your chore in 'Add a Chore'
                </h2>
            ...
            <div className="shadow-none col-5 second-section">
              <img
                src={addachore}
                className="home-img home-img-appear  "
                alt="home-img-light"
        ...
        <div className="d-flex homepage-card-container m-2">
          <div className="shadow-none col-5 third-section">
            <img
              src={singlemetrics}
              className="home-img home-img-appear"
              alt="home-img-light"
          ...
          <div className="container third-section text-section d-flex pt-4">
            ...
            <div className="container third-section  col-4 pt-4">
              <h2 className="pt-2 text-white home-page-card-titles">
          ...
          <div className="d-flex homepage-card-container m-2 pt-4 ">
            <div className="text-section fourth-section d-flex">
              ...
              <div className="container text-white col-4 pt-4">
                <h2 className="home-page-card-titles pt-2">
            ...
            <div className="fourth-section shadow-none col-5">
              <img
                src={teammetrics}
                className="home-img home-img-appear"
                alt="home-img-light"
